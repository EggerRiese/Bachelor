...
from tester_RealSense import ModelTester
from helper_ply import read_ply
from helper_tool import ConfigRealSense as cfg
...
if __name__ == '__main__':
    ...
    validation_nr = FLAGS.validation_nr
    dataset = RealSense(validation_nr)
