...
import h5py
f = h5py.File('/home/joshua/Dokumente/Bachelor/src/3DObjectMeasurementWithSegmentation/DataPrepForPointNet/real_data.h5','r')
...
f_random_rotate_for_testing = h5py.File('../test.h5','w')
